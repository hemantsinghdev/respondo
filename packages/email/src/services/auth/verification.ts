...
export const sendVerificationEmail = async (
              ...
              <table width="100%" max-width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #0D0D0D; border: 1px solid rgba(255,255,255,0.05); border-radius: 24px; overflow: hidden; max-width: 600px;">
                ...
                <tr>
                  <td align="center" style="padding: 48px 40px 20px 40px;">
                    <div style="display: inline-block; padding: 1px; background: linear-gradient(to right, #06B6D4, #2563EB); border-radius: 12px;">
                      <div style="background: #0D0D0D; padding: 12px 24px; border-radius: 11px;">
                        <span style="color: #FFFFFF; font-weight: bold; font-size: 22px; letter-spacing: -0.5px;">Respondo</span>
                      </div>
                    </div>
                  </td>
                </tr>
  ...
  await brevo.transactionalEmails.sendTransacEmail({
    sender: { email: "no-reply@respondo.com", name: "Respondo CRM" },
    to: [{ email, name }],
